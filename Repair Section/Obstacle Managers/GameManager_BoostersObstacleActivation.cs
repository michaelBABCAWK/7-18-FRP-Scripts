...
public class GameManager_BoostersObstacleActivation : MonoBehaviour
{
    ...
    {
        int numberOfFinishes = FindObjectsOfType<GameManager_BoostersObstacleActivation>().Length;
    ...
    private void SetFinishComponents()
    {
        ...
        objWins = GameManager_AllSectionCompletionTrackers.BoostersCompletions;
    }
